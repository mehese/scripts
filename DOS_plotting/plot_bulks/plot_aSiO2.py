...
plt.plot(x, y*1.5, color='#ff0000', label='amorphous silica', linewidth=2)

pc5  = np.loadtxt('../../../PDOS_files/qz_5pc_tot_opt.dat')
plt.plot(pc5[:,0], pc5[:,1], color='#ff9900', label=r'$\alpha$-quartz', linewidth=2)
...
plt.savefig('dos_aSiO2.png', dpi=400, bbox_inches='tight')
