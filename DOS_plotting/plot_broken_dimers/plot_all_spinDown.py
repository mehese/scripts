...
plt.plot(c3_E,-c3_58_d, 'k-', linewidth=1.5)
plt.plot(c3_E,-c3_66_d, 'k-', linewidth=1.5)

# CELL 4
c4_Ef = -2.84
c4 = np.loadtxt('c4_65_119.dat')
c4_E, c4_dos_u, c4_65_u, c4_119_u, c4_dos_d, c4_65_d, c4_119_d = tuple(c4[:, i] for i in range(7))
plt.plot(c4_E,-c4_65_d,  'k-', linewidth=1.5)
plt.plot(c4_E,-c4_119_d, 'k-', linewidth=1.5)
...
plt.plot(c5_E,-c5_82_d,  'k-', linewidth=1.5)
plt.plot(c5_E,-c5_102_d, 'k-', linewidth=1.5)
...
plt.plot(c6_E,-c6_66_d,  'k-', linewidth=1.5)
plt.plot(c6_E,-c6_101_d, 'k-', linewidth=1.5)
plt.plot(c6_E,-c6_119_d, 'k-', linewidth=1.5)

# CELL 2 OX
c2ox_Ef = -2.41
c2ox = np.loadtxt('c2ox_72_86_126.dat')
c2ox_E, c2ox_dos_u, c2ox_72_u, _, _, c2ox_dos_d, c2ox_72_d, _, _ = tuple(c2ox[:, i] for i in range(9))
plt.plot(c2ox_E,-c2ox_72_d, 'k-', linewidth=1.5)
...
plt.plot(c3ox_E,-c3ox_65_d, 'k-', linewidth=1.5)
...
plt.plot(c5ox_E,-c5ox_65_d, 'k-', linewidth=1.5)
#
...
plt.title('broken dimer defects (spin down)') 
