...
plt.plot(c1_E, c1_142_u, 'k-', linewidth=1.5)
plt.plot(c1_E, c1_144_u, 'k-', linewidth=1.5)
...
plt.plot(c2_E, c2_124_u, 'k-', linewidth=1.5)
plt.plot(c2_E, c2_125_u, 'k-', linewidth=1.5)
plt.plot(c2_E, c2_134_u, 'k-', linewidth=1.5)
...
plt.plot(c3_E, c3_81_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_113_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_128_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_134_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_135_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_147_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_148_u, 'k-', linewidth=1.5)
...
plt.plot(c4_E, c4_124_u, 'k-', linewidth=1.5)
plt.plot(c4_E, c4_125_u, 'k-', linewidth=1.5)
plt.plot(c4_E, c4_127_u, 'k-', linewidth=1.5)
plt.plot(c4_E, c4_130_u, 'k-', linewidth=1.5)
plt.plot(c4_E, c4_136_u, 'k-', linewidth=1.5)
...
plt.plot(c5_E, c5_133_u, 'k-', linewidth=1.5)
plt.plot(c5_E, c5_135_u, 'k-', linewidth=1.5)
plt.plot(c5_E, c5_137_u, 'k-', linewidth=1.5)
...
plt.plot(c6_E, c6_125_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_128_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_131_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_135_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_136_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_137_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_144_u, 'k-', linewidth=1.5)
plt.plot(c6_E, c6_147_u, 'k-', linewidth=1.5)

# CELL 2 OX
c2ox_Ef = -2.41
c2ox = np.loadtxt('c2ox_84_128_136_138.dat')
c2ox_E, c2ox_dos_u, c2ox_84_u, c2ox_128_u, c2ox_136_u, c2ox_138_u, c2ox_dos_d, c2ox_84_d,c3ox_128_d, c2ox_136_d, c2ox_138_d = tuple(c2ox[:, i] for i in range(11))
...
plt.plot(c2ox_E, c2ox_84_u, 'k-', linewidth=1.5)
plt.plot(c2ox_E, c2ox_128_u, 'k-', linewidth=1.5)
plt.plot(c2ox_E, c2ox_136_u, 'k-', linewidth=1.5)
plt.plot(c2ox_E, c2ox_138_u, 'k-', linewidth=1.5)
plt.plot(c2ox_E, c2ox_148_u, 'k-', linewidth=1.5)
...
plt.plot(c3ox_E, c3ox_72_u, 'k-', linewidth=1.5)
plt.plot(c3ox_E, c3ox_97_u, 'k-', linewidth=1.5)
plt.plot(c3ox_E, c3ox_98_u, 'k-', linewidth=1.5)
plt.plot(c3ox_E, c3ox_136_u, 'k-', linewidth=1.5)
plt.plot(c3ox_E, c3ox_149_u, 'k-', linewidth=1.5)
plt.plot(c3ox_E, c3ox_153_u, 'k-', linewidth=1.5)
plt.plot(c3ox_E, c3ox_154_u, 'k-', linewidth=1.5)
...
plt.plot(c5ox_E, c5ox_98_u, 'k-', linewidth=1.5)
plt.plot(c5ox_E, c5ox_141_u, 'k-', linewidth=1.5)
plt.plot(c5ox_E, c5ox_150_u, 'k-', linewidth=1.5)
plt.plot(c5ox_E, c5ox_151_u, 'k-', linewidth=1.5)
plt.plot(c5ox_E, c5ox_154_u, 'k-', linewidth=1.5)
