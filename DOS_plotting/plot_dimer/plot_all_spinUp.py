...
plt.plot(c1_E, c1_57_u, 'k-', linewidth=1.5)
plt.plot(c1_E, c1_113_u, 'k-', linewidth=1.5)
...
plt.plot(c2_E, c2_102_u, 'k-', linewidth=1.5)
plt.plot(c2_E, c2_114_u, 'k-', linewidth=1.5)
...
plt.plot(c3_E, c3_73_u, 'k-', linewidth=1.5)
plt.plot(c3_E, c3_101_u, 'k-', linewidth=1.5)
#
## CELL 4
#c4_Ef = -2.84
########## N/A #######################
...
plt.plot(c3ox_E, c3ox_73_u, 'k-', linewidth=1.5)
...
plt.plot(c5ox_E, c5ox_117_u, 'k-', linewidth=1.5)
...
plt.title('dimer defects (spin up)') 
