...
plt.plot(c1_E, c1_142_u, 'm-', linewidth=1.5, label='Atom 142 (.0), C1')
plt.plot(c1_E, c1_142_d, 'm-', linewidth=1.5)
...
plt.plot(c3_E, c3_148_u, 'g-', linewidth=1.5, label='Atom 148 (.8), C3')
plt.plot(c3_E, c3_148_d, 'g-', linewidth=1.5)
...
plt.plot(c4_E, c4_136_u, 'b-', linewidth=1.5, label='Atom 136 (.0), C4')
plt.plot(c4_E, c4_136_d, 'b-', linewidth=1.5)
...
plt.plot(c3ox_E, c3ox_154_u, 'r-', linewidth=1.5, label='Atom 154 (.6), C3OX')
plt.plot(c3ox_E, c3ox_154_d, 'r-', linewidth=1.5)
...
plt.plot(c5ox_E, c5ox_154_u, 'y-', linewidth=1.5, label='Atom 154 (.8), C5OX')
plt.plot(c5ox_E, c5ox_154_d, 'y-', linewidth=1.5)
